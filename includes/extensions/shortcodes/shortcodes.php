...
class Am_Shortcodes {
    ...
    function __construct() {
        ...
        add_action('media_buttons_context',  array( $this, 'add_am_tinymce_media_button') );
    ...
    function add_am_tinymce_media_button($context){
        return $context.="
        <a href=\"#TB_inline?width=640&inlineId=am_shortcode_popup&width=640&height=513\" class=\"button thickbox perfect-column-btn\" id=\"am_shortcode_popup_button\" title=\"All Shortcodes\"><span class=\"dashicons dashicons-media-code\"></span>".__('All Shortcodes','am')."</a>";
    }
